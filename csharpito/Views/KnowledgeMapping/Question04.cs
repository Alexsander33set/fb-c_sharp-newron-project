...
namespace csharpito.Views.VocacionalTest
{
    public partial class Question04 : Form
    {
        ...
        {
            this.Hide();
            Question05 NewPage = new Question05();
            NewPage.Show();
        }
        ...
        private void agreeLinkLabel_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {

        }

        private void Question04_Load(object sender, EventArgs e)
        {
